...
function ans1() {
    ...
    answer.textContent = "Step back and observe the situation for a few minutes. Wait to see if a parent or is in the road, remove the baby and bring to a rescue center."
}
